...
Wave 4A Blocks A-B now layer a bounded governance runtime landing zone and static civic policy pack onto the Wave 1 foundation, Wave 2 entity ontology extension, and Wave 3 NATS bridge substrate. The repo now ships a command-request activation path with one local policy source, not a full governance runtime.
...
- Governance runtime landing zone and policy pack: `src/governance/runtime/*.js`
...
- Proof surfaces: `tests/bridge*.test.js`, `tests/governance.runtime.test.js`, `tests/governance.policyPack.test.js`, `tests/config.test.js`, `tests/deny-patterns.test.js`, `tests/entities.test.js`, `tests/fixtures/governance/*.json`, `tests/fixtures/nats/*.json`, `scripts/synthetic-constellation.js`

## Current Repo State

- Wave 1 foundation, Wave 2 entity ontology extension, Wave 3 transport-only bridge, and the Wave 4A bounded governance runtime plus static civic policy pack are landed in-repo.
...
- The governance transport adapter now delegates `command_request` evaluation into `src/governance/runtime/` and may return `ALLOW`, `HOLD`, or `BLOCK`.
...
- Publisher behavior remains intentionally unchanged for `ALLOW` and fail-closed `BLOCK`.
...
- Bridge specs: `docs/specs/WAVE3_NATS_BRIDGE.md`, `docs/specs/NATS_EVENT_COMMAND_TRANSLATION.md`
- Governance runtime spec and closeouts: `docs/specs/WAVE4A_GOVERNANCE_RUNTIME.md`, `docs/closeouts/WAVE4A_BLOCK_A_CLOSEOUT.md`, `docs/closeouts/WAVE4A_BLOCK_B_CLOSEOUT.md`
- Bridge and runtime tests/fixtures: `tests/bridge*.test.js`, `tests/governance.runtime.test.js`, `tests/governance.policyPack.test.js`, `tests/fixtures/governance/*.json`, `tests/fixtures/nats/*.json`, `scripts/synthetic-constellation.js`
...
- Closeouts: `docs/closeouts/README.md`, `docs/closeouts/WAVE1_CLOSEOUT.md`, `docs/closeouts/WAVE2_CLOSEOUT.md`, `docs/closeouts/WAVE3_CLOSEOUT.md`, `docs/closeouts/WAVE4A_BLOCK_A_CLOSEOUT.md`, `docs/closeouts/WAVE4A_BLOCK_B_CLOSEOUT.md`
