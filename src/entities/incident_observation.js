...
const ENTITY_TYPE = "incident_observation";
...
function createIncidentObservation(overrides = {}) {
  const entity = {
...
function validateIncidentObservation(entity) {
  const errors = [];
...
module.exports = {
  ENTITY_TYPE,
  LIFECYCLE_STATES,
  createIncidentObservation,
  validateIncidentObservation,
};
