...
6. [`docs/ENGINE_INDEX.md`](docs/ENGINE_INDEX.md)
...
17. [`docs/specs/MERIDIAN_V2D_EMBODIED_FOREMAN_CIVIC_PROOF_THEATER.md`](docs/specs/MERIDIAN_V2D_EMBODIED_FOREMAN_CIVIC_PROOF_THEATER.md)
18. [`docs/closeouts/MERIDIAN_V2D_EMBODIED_FOREMAN_CIVIC_PROOF_THEATER_CLOSEOUT.md`](docs/closeouts/MERIDIAN_V2D_EMBODIED_FOREMAN_CIVIC_PROOF_THEATER_CLOSEOUT.md)
19. Relevant active-task specs in `docs/specs/`
20. Relevant active-task closeouts in `docs/closeouts/`
