...
Wave 4A Block A now layers a bounded governance runtime landing zone onto the Wave 1 foundation, Wave 2 entity ontology extension, and Wave 3 NATS bridge substrate. The repo now ships a command-request activation path, not a full governance runtime.
...
- Governance runtime landing zone: `src/governance/runtime/*.js`
...
- Proof surfaces: `tests/bridge*.test.js`, `tests/governance.runtime.test.js`, `tests/config.test.js`, `tests/deny-patterns.test.js`, `tests/entities.test.js`, `tests/fixtures/governance/*.json`, `tests/fixtures/nats/*.json`, `scripts/synthetic-constellation.js`

## Current Repo State

- Wave 1 foundation, Wave 2 entity ontology extension, Wave 3 transport-only bridge, and Wave 4A Block A governance runtime landing zone are landed in-repo.
...
- `event_observation` remains explicitly blocked and deferred in Wave 4A Block A.
...
- Bridge specs: `docs/specs/WAVE3_NATS_BRIDGE.md`, `docs/specs/NATS_EVENT_COMMAND_TRANSLATION.md`
- Governance runtime spec and closeout: `docs/specs/WAVE4A_GOVERNANCE_RUNTIME.md`, `docs/closeouts/WAVE4A_BLOCK_A_CLOSEOUT.md`
- Bridge and runtime tests/fixtures: `tests/bridge*.test.js`, `tests/governance.runtime.test.js`, `tests/fixtures/governance/*.json`, `tests/fixtures/nats/*.json`, `scripts/synthetic-constellation.js`
...
- Closeouts: `docs/closeouts/README.md`, `docs/closeouts/WAVE1_CLOSEOUT.md`, `docs/closeouts/WAVE2_CLOSEOUT.md`, `docs/closeouts/WAVE3_CLOSEOUT.md`, `docs/closeouts/WAVE4A_BLOCK_A_CLOSEOUT.md`
